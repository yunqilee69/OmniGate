...
export default function Settings() {
  ...
  return (
    <div style={{ display: 'flex', gap: 24, minHeight: 'calc(100vh - 112px)' }}>
      {/* 侧边栏导航 */}
      <aside style={{
        width: 200,
        flexShrink: 0,
        ...
        <div style={{
          ...
          {(['breaker', 'retry', 'stream', 'capture', 'log', 'affinity', 'pricing', 'fallback'] as Section[]).map(sec => (
            <div
              ...
              style={{
                padding: '10px 16px',
                cursor: 'pointer',
                color: activeSection === sec ? '#171717' : '#4d4d4d',
                background: activeSection === sec ? '#fafafa' : '#ffffff',
                borderLeft: activeSection === sec ? '3px solid #0070f3' : '3px solid transparent',
                fontSize: 14,
          ...
          <div
            ...
            style={{
              padding: '10px 16px',
              cursor: 'pointer',
              color: activeSection === 'danger' ? '#171717' : '#4d4d4d',
              background: activeSection === 'danger' ? '#fafafa' : '#ffffff',
              borderLeft: activeSection === 'danger' ? '3px solid #ee0000' : '3px solid transparent',
              fontSize: 14,
              fontWeight: activeSection === 'danger' ? 500 : 400,
              transition: 'all 0.2s ease',
            }}
            onMouseEnter={(e) => {
          ...
          <Form form={form} layout="vertical">
            ...
            {activeSection === 'danger' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                <div>
                  <div style={{ fontSize: 15, fontWeight: 500, color: '#171717', marginBottom: 8 }}>
                    立即清理过期数据
                  </div>
                  <div style={{ color: '#8f8f8f', fontSize: 13, lineHeight: '20px', marginBottom: 12 }}>
